...
if (LIBSQUID_INCLUDE_DIR AND LIBSQUID_LIBRARIES)
  ...
  if (LIBSQUID_FOUND)
    ...
    STRING(REGEX REPLACE ".*#define LIBSQUID_VERSION[^0-9]*([0-9]+)\\.([0-9]+).*" "\\1.\\2" LIBSQUID_VERSION_STRING "${LIBSQUID_H}")
    STRING(REGEX REPLACE "^([0-9]+)[.]([0-9]+)" "\\1" LIBSQUID_VERSION_MAJOR ${LIBSQUID_VERSION_STRING})
    STRING(REGEX REPLACE "^([0-9]+)[.]([0-9]+)" "\\2" LIBSQUID_VERSION_MINOR ${LIBSQUID_VERSION_STRING})
    message(STATUS "found version string ${LIBSQUID_VERSION_STRING}")

    if (NOT LIBSQUID_FIND_QUIETLY)
      message(STATUS "Found LIBSQUID ${LIBSQUID_VERSION_MAJOR}.${LIBSQUID_VERSION_MINOR}: ${LIBSQUID_LIBRARIES}")
